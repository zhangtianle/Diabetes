...
def main():
    ...
    for train_index, test_index in kf.split(train_x):
        ...
        exported_pipeline0 = make_pipeline(
            ...
            ExtraTreesRegressor(bootstrap=False, max_features=0.2, min_samples_leaf=3, min_samples_split=16,n_estimators=100)
        )
        ...
        stack = Ensemble(n_splits=10,
                         ...
                         base_models=(knn,lr,linear_svr, ridge,en, gbm, xgb, et, exported_pipeline0, exported_pipeline1, exported_pipeline2))
